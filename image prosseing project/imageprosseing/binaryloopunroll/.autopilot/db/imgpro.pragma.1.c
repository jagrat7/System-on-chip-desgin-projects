...
void compressf(int as[25][25],int bs[744])
{_ssdm_SpecArrayDimSize(as, 25);_ssdm_SpecArrayDimSize(bs, 744);
...
# 258 "imageprosseing/imgpro.c"
}
void decompressf(int da[744],int db[25][25])
{_ssdm_SpecArrayDimSize(da, 744);_ssdm_SpecArrayDimSize(db, 25);
  int i,f,j,count=1,ovr=0,flg1=0;
