...
HD_PWD='C:/Users/raoja/Desktop/uni/520/finalproject/maybe/maybe.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log halol_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source halol_wrapper.tcl -notrace
