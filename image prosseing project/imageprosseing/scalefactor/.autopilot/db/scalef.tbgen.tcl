...
set C_modelArgList {
	{ as int 32 regular {array 10000 { 1 3 } 1 1 }  }
	{ bs int 32 regular {array 10000 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "160201", "EstimateLatencyMax" : "160201",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.scalef_dmul_64ns_bkb_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.scalef_sitodp_32ncud_U2", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	scalef {
		as {Type I LastRead 2 FirstWrite -1}
		bs {Type O LastRead -1 FirstWrite 17}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "160201", "Max" : "160201"}
	, {"Name" : "Interval", "Min" : "160202", "Max" : "160202"}
]}
...
set Spec2ImplPortList { 
	as { ap_memory {  { as_address0 mem_address 1 14 }  { as_ce0 mem_ce 1 1 }  { as_q0 mem_dout 0 32 } } }
	bs { ap_memory {  { bs_address0 mem_address 1 14 }  { bs_ce0 mem_ce 1 1 }  { bs_we0 mem_we 1 1 }  { bs_d0 mem_din 1 32 } } }
}
