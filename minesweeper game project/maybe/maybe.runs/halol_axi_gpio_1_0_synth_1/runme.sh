...
HD_PWD='C:/Users/raoja/Desktop/uni/520/finalproject/maybe/maybe.runs/halol_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log halol_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source halol_axi_gpio_1_0.tcl
