...
// ==============================================================
#ifndef __scalef_sitodp_32ncud__HH__
#define __scalef_sitodp_32ncud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(scalef_sitodp_32ncud) {
    ...
    SC_CTOR(scalef_sitodp_32ncud):  ACMP_sitodp_U ("ACMP_sitodp_U") {
