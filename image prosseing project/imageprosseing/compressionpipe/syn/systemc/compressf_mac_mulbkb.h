...
// ==============================================================
#ifndef __compressf_mac_mulbkb__HH__
#define __compressf_mac_mulbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(compressf_mac_mulbkb) {
    ...
    SC_CTOR(compressf_mac_mulbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
