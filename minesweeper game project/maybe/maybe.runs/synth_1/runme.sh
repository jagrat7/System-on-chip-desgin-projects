...
HD_PWD='C:/Users/raoja/Desktop/uni/520/finalproject/maybe/maybe.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log halol_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source halol_wrapper.tcl
