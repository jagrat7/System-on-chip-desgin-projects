...
set C_modelArgList {
	{ ai int 32 regular {array 10000 { 1 3 } 1 1 }  }
	{ bi int 32 regular {array 10000 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "20003", "EstimateLatencyMax" : "20003",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.invertf_mac_muladbkb_U1", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	invertf {
		ai {Type I LastRead 2 FirstWrite -1}
		bi {Type O LastRead -1 FirstWrite 4}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "20003", "Max" : "20003"}
...
set Spec2ImplPortList { 
	ai { ap_memory {  { ai_address0 mem_address 1 14 }  { ai_ce0 mem_ce 1 1 }  { ai_q0 mem_dout 0 32 } } }
	bi { ap_memory {  { bi_address0 mem_address 1 14 }  { bi_ce0 mem_ce 1 1 }  { bi_we0 mem_we 1 1 }  { bi_d0 mem_din 1 32 } } }
}
