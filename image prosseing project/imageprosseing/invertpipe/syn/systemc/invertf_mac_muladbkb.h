...
// ==============================================================
#ifndef __invertf_mac_muladbkb__HH__
#define __invertf_mac_muladbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(invertf_mac_muladbkb) {
    ...
    SC_CTOR(invertf_mac_muladbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
